...
PARAMS = {
    "ICICIBANK": dict(fast=400, mid1=560,  mid2=800,  mid3=1600, atr_mult=0.0),
    "INFY":       dict(fast=240, mid1=1200, mid2=200,  mid3=400,  atr_mult=0.0),
    "RELIANCE":   dict(fast=200, mid1=1040, mid2=400,  mid3=800,  atr_mult=0.0),  # ← updated
}
